...
const resetDefaultColors = document.querySelector(".reset-default-colors");
...
function mostrarDataDate(){
    infoText.textContent += `${days[currentDate.getDay()]} ${currentDate.getDate()} de ${months[currentDate.getMonth()]} del ${currentDate.getFullYear()}`;
...
resetDefaultColors.addEventListener("click", resetColorsDefault);
